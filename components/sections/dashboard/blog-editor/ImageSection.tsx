...
interface ImageSectionProps {
  value: string; // The URL for display
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[28px] p-8 shadow-sm font-sans hover:border-primary/30 transition-colors duration-300">
      <MediaPickerModal 
        ...
        onSelect={(media) => onChange(media.url, media.id)}
      />
        ...
        {value ? (
          ...
          >
            ...
            <div className="text-center px-4 font-sans">
              <p className="text-[16px] font-bold text-gray-800 dark:text-gray-200 group-hover:text-[#17838F] transition-colors duration-300">Pilih dari Pustaka Media</p>
              <p className="text-[14px] text-gray-400 group-hover:text-gray-500 transition-colors duration-300">Pilih gambar fail tajuk yang telah dimuat naik</p>
            </div>
            <Button variant="outline" className="mt-8 rounded-xl border-gray-100 dark:border-gray-800 gap-2 px-8 h-12 bg-white/70 backdrop-blur-sm text-[15px] font-bold group-hover:border-[#17838F]/50 group-hover:bg-[#17838F]/5 group-hover:text-[#17838F] transition-all duration-300 pointer-events-none">
